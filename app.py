...
# En Render usamos variable de entorno. Localmente podés usar el archivo si querés
if os.getenv("FIREBASE_CREDENTIALS"):
    # Render: JSON desde variable de entorno
    cred_dict = json.loads(os.getenv("FIREBASE_CREDENTIALS"))
    cred = credentials.Certificate(cred_dict)
else:
    # Local: usa el archivo (para pruebas en tu PC)
